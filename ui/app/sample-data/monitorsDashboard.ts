...
const monitorsDashboard: DashboardResource = {
  kind: 'Dashboard',
  metadata: {
    name: 'Monitors Dashboard',
    project: 'perses',
  ...
  spec: {
    ...
    panels: {
      monitorFirst: {
        kind: 'LineChart',
        display: { name: 'Chronoprom instance is down', description: 'Description text' },
        options: {
          queries: [
            {
      ...
      monitorSecond: {
        kind: 'LineChart',
        display: { name: 'Prometheus Config Generation Failure', description: 'Description text' },
        options: {
          queries: [
            {
              kind: 'PrometheusGraphQuery',
      ...
      monitorThird: {
        kind: 'LineChart',
        display: { name: 'Chronoprom CPU Utilization High', description: 'Description text' },
        options: {
          queries: [
            {
              kind: 'PrometheusGraphQuery',
      ...
      monitorFourth: {
        kind: 'LineChart',
        display: { name: 'Chronoprom Memory Utilization High', description: 'Description text' },
        options: {
          queries: [
            {
              kind: 'PrometheusGraphQuery',
